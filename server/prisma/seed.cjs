...
async function main() {
	...
	const keycloakAdmins = [
		{
			...
			bloodType: 'O+',
			profileImage:
				'https://drive.google.com/file/d/1NxyufNZaZmDG-_fRyFZq8wCuvM0ryiRK/view?usp=drive_link',
			shift: '08:00AM - 4:00PM',
		},
		{
			...
			address: '456 Oak Avenue, Los Angeles, USA',
			bloodType: 'A-',
			profileImage:
				'https://drive.google.com/file/d/1V7kbOdBDmmVrtwsig5djE5pPBASK37_0/view?usp=drive_link',
		...
		},
		{
			...
			address: '789 Pine Lane, Chicago, USA',
			bloodType: 'B+',
			profileImage:
				'https://drive.google.com/file/d/1NxyufNZaZmDG-_fRyFZq8wCuvM0ryiRK/view?usp=drive_link',
			shift: '12:00AM - 08:00AM',
		},
		{
			...
			address: '321 Maple Road, Houston, USA',
			bloodType: 'AB+',
			profileImage:
				'https://drive.google.com/file/d/1V7kbOdBDmmVrtwsig5djE5pPBASK37_0/view?usp=drive_link',
			shift: '08:00AM - 4:00PM',
		},
		{
			...
			address: '654 Cedar Street, Miami, USA',
			bloodType: 'O-',
			profileImage:
				'https://drive.google.com/file/d/1NxyufNZaZmDG-_fRyFZq8wCuvM0ryiRK/view?usp=drive_link',
			shift: '4.00PM - 12.00AM',
	...
	const keycloakDoctors = [
		{
			...
			address: '12 Willow Drive, Boston, USA',
			bloodType: 'A+',
			profileImage:
				'https://drive.google.com/file/d/1Wsgd23AzR_x0HVYI6TqnMPQ_67QVzDcg/view?usp=drive_link',
			shift: '08:00AM - 4:00PM',
			onCall: 'Yes',
		...
		},
		{
			...
			address: '34 Birch Lane, San Francisco, USA',
			bloodType: 'B+',
			profileImage:
				'https://drive.google.com/file/d/16uhNQIR5Yj0T8x_sRsV8WdFhdFgvgUON/view?usp=drive_link',
			shift: '4.00PM - 12.00AM',
			onCall: 'No',
		...
		},
		{
			...
			address: '56 Spruce Street, Seattle, USA',
			bloodType: 'O-',
			profileImage:
				'https://drive.google.com/file/d/1Wsgd23AzR_x0HVYI6TqnMPQ_67QVzDcg/view?usp=drive_link',
			shift: '12:00AM - 08:00AM',
		...
		},
		{
			...
			address: '78 Aspen Avenue, Denver, USA',
			bloodType: 'AB+',
			profileImage:
				'https://drive.google.com/file/d/16uhNQIR5Yj0T8x_sRsV8WdFhdFgvgUON/view?usp=drive_link',
			shift: '08:00AM - 4:00PM',
		...
		},
		{
			...
			address: '90 Chestnut Road, Austin, USA',
			bloodType: 'B-',
			profileImage:
				'https://drive.google.com/file/d/1Wsgd23AzR_x0HVYI6TqnMPQ_67QVzDcg/view?usp=drive_link',
			shift: '4.00PM - 12.00AM',
	...
	const keycloakNurses = [
		...
		},
		{
			...
			address: '202 Oak Avenue, Chicago, USA',
			bloodType: 'A-',
			profileImage:
				'https://drive.google.com/file/d/1sC1fFWy6toOQAA5IMQ56nccNV8kwXb2q/view?usp=drive_link',
			shift: '12:00AM - 08:00AM',
			onCall: 'Yes',
...

		{
			...
			address: '303 Pine Lane, New York, USA',
			bloodType: 'B+',
			profileImage:
				'https://drive.google.com/file/d/1suI42zPonNMHB27QQOczOIpROqX74t3r/view?usp=drive_link',
...

		{
			...
			address: '404 Maple Road, Los Angeles, USA',
			bloodType: 'AB+',
			profileImage:
				'https://drive.google.com/file/d/1sC1fFWy6toOQAA5IMQ56nccNV8kwXb2q/view?usp=drive_link',
			shift: '4.00PM - 12.00AM',
		...
		},
		{
			...
			address: '505 Cedar Street, Miami, USA',
			bloodType: 'O-',
			profileImage:
				'https://drive.google.com/file/d/1suI42zPonNMHB27QQOczOIpROqX74t3r/view?usp=drive_link',
			shift: '08:00AM - 4:00PM',
			onCall: 'No',
			department: 'Surgery (or General Surgery)',
		},
	];
	...
	const keycloakPatients = [
		{
			...
			address: '10 Baker Street, New York, USA',
			bloodType: 'O+',
			profileImage:
				'https://drive.google.com/file/d/1gt2oeyECb9coJCwJEi32UUEVvKc9GY0o/view?usp=drive_link',
			emergencyContact: '+1 202-555-0501',
		...
		},
		{
			...
			address: '20 Oxford Street, Los Angeles, USA',
			bloodType: 'A-',
			profileImage:
				'https://drive.google.com/file/d/1WDGEkgREn6WMhu9N8ny_eDjrdIahfzds/view?usp=drive_link',
			emergencyContact: '+1 202-555-0502',
			condition: 'Diabetes',
		},
		{
			...
			address: '30 Cherry Lane, Chicago, USA',
			bloodType: 'B+',
			profileImage:
				'https://drive.google.com/file/d/1gt2oeyECb9coJCwJEi32UUEVvKc9GY0o/view?usp=drive_link',
			emergencyContact: '+1 202-555-0503',
			condition: 'Asthma',
		},
		{
			...
			address: '40 Walnut Avenue, Seattle, USA',
			bloodType: 'AB+',
			profileImage:
				'https://drive.google.com/file/d/1WDGEkgREn6WMhu9N8ny_eDjrdIahfzds/view?usp=drive_link',
			emergencyContact: '+1 202-555-0504',
			condition: 'Anemia',
		},
		{
			...
			address: '50 Pine Road, Miami, USA',
			bloodType: 'O-',
			profileImage:
				'https://drive.google.com/file/d/1gt2oeyECb9coJCwJEi32UUEVvKc9GY0o/view?usp=drive_link',
			emergencyContact: '+1 202-555-0505',
			condition: 'Migraine',
		},
	];
	...
	const patientHistoryData = [
		...
		},
		{
			...
			menstrualHistroy: 'Regular cycles, 28 09:00 - 17:00s',
	...
	const clinicalDetailsData = [
		{
			...
			hpi: 'Patient reports a 3-day history of throbbing headaches, worse in the 4.00PM - 12.00AMs.',
			allergies: 'None',
