...
export type OverviewChartConfig = Record<UserRole, ChartData[]>;

export const getOverviewChartData = async (): Promise<OverviewChartConfig> => {
	return {
		admin: [
			{
		...
		patient: [
			...
			},
			{
				...
				lines: [
					{ key: 'meds', color: '#ef4444', label: 'Medications' },
				],
			},
		],
	};
