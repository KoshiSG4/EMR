							...
							<form
								...
								<div>
									...
									<Input
										...
										className={`w-full rounded-lg border border-white/10 bg-white/4 px-3 py-2 text-black/50 placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-indigo-400 ${
											errors.email
